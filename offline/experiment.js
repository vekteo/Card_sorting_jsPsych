...
function expStart(subject, session) {
    ...
    on_close: function() {
        jsPsych.data.get().localSave('csv',`WCST_Subject_${subjectId}_Session_${sessionNumber}_quitted_output.csv`); 
    },
    on_data_update: function () {
        ...
        on_finish: function() {       
            jsPsych.data.get().localSave('csv',`WCST_Subject_${subjectId}_Session_${sessionNumber}_output.csv`); 
        },
    });
}